import torch
from .custom_resnet import Bottleneck, BasicBlock, ResNet, model_urls
...
def resnet10(pretrained=False, progress=True,quantize=False, **kwargs):
    ...
    """
    return _resnet('resnet10', QuantizableBasicBlock, [1, 1, 1, 1], pretrained, progress, quantize,
                   **kwargs)


def resnet14(pretrained=False, progress=True, quantize=False,**kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet14', QuantizableBasicBlock, [1, 1, 2, 2], pretrained, progress,quantize,
                   **kwargs)
...
def resnet20(pretrained=False, progress=True, quantize=False, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet20', QuantizableBasicBlock, [2, 2, 3, 2], pretrained, progress,
                   quantize, **kwargs)


def resnet26(pretrained=False, progress=True, quantize=False, **kwargs):
