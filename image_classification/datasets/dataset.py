...
# from fastai.vision.all import get_transforms, untar_data, URLs
# from fastai.vision.data import untar_data, URLs, ImageDataLoaders
# from fastai.vision.augment import aug_transforms
# from fastai.vision.core import cifar_stats
...
#     return ImageDataLoaders.from_folder(path, train='train', valid=val, bs=batch_size, size=sz, ds_tfms=tfms, classes=classes).normalize(stats)
